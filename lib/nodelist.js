define(["sorttable", "virtual-dom", "numeral"], function (SortTable, V, numeral) {
  ...
  var headings = [{ name: "Knoten",
                  ...
                  { name: "Clients",
                    sort: function (a, b) {
                      return (("clients" in a.statistics && a.statistics.clients >= 0) ? a.statistics.clients : -1) -
                             (("clients" in b.statistics && b.statistics.clients >= 0) ? b.statistics.clients : -1)
                    },
                    reverse: true
                  }]
  ...
  return function(router) {
    function renderRow(d) {
      ...
      var td3 = V.h("td", d.flags.online ? (("clients" in d.statistics && d.statistics.clients >= 0) ? numeral(d.statistics.clients).format("0,0") : "N/A") : "-")
